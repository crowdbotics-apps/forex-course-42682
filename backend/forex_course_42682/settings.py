"""
Django settings for forex_course_42682 project.
...
ROOT_URLCONF = 'forex_course_42682.urls'
...
WSGI_APPLICATION = 'forex_course_42682.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "forex_course_42682 API",
    "DESCRIPTION": "API documentation for forex_course_42682 App",
    "VERSION": "v1",
}
